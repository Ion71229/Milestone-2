...
const start_btn = document.querySelector(".start_btn .press");
...
function showQuestions(game){
    ...
    let que_tag = '<span>'+ questions[game].numb + "." + questions[game].question +'</span>';
...
let totalQuesCountTag = '<span><p>'+ game +'</p>of<p>'+ questions.length +'</p>Questions</span>';
